...
// UnmarshalJSON unmarshaler implementation for Int16.
func (j *Int16) UnmarshalJSON(data []byte) error {
...
// MarshalJSON marshaler implementation for Int16.
func (j Int16) MarshalJSON() ([]byte, error) {
